          ...
          >
            <div className="p-6">
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    <dt className="text-sm font-medium text-gray-500 truncate">Review Management</dt>
                    <dd className="text-lg font-medium text-gray-900">Manage Reviews</dd>
                  </dl>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  <dl>
                    ...
                    <dd className="text-lg font-medium text-gray-900">Generate Reports</dd>
                  </dl>
                </div>
              </div>
            </div>
            ...
            <div className="flex">
              ...
              <div className="ml-3">
                ...
                <div className="mt-2 text-sm text-blue-700">
                  <p>
                    As an admin, you have full access to manage users, services, and reviews. 
                    You do not have access to book services or browse the service catalog.
                  </p>
                </div>
              </div>
            </div>
